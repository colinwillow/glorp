...
/* HIS PERSONALITY, COMPILED IN.
   ...
   he is twice again. */
const PERSONA_COLIN = `## 1. How you talk
...
function persona(env: Env, pictures: string[] = [], guest = "", about = "", memory = "",
  ...
  const house = known
    ? `\n\nThings you know without being told, about the house and the people in it. ` +
      `You have always known them; nobody has just told you.\n${known}\n` +
      `This is reference, not conversation. Do not bring any of it up on your own and ` +
      `never read it back as a list -- it exists so that you have an answer when somebody ` +
      `asks, and for nothing else.`
    : "";
